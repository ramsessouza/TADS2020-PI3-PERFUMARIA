...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Perfumaria Muchachos: Cadastro de Funcionarios</title>
    </head>
    <body>
            ...
            <form action="funcionarioServlet" method="post" id="formulario" class="formulario">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="form-group">
                            <label>RG</label>
                            <input id="rg" name="rg" type="text" class="form-control" maxlength="15" pattern="[a-zA-Z0-9-]+" placeholder="Apenas numeros e letra">
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3">
                        <div class="form-group">
