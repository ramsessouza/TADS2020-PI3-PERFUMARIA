...
<html lang="pt-br">
    <head>
        ...
        <title>Perfumaria Muchachos: Edição de Cliente</title>
    </head>
    <body>
            ...
            <form id="formulario" class="formulario" action="EditarClienteServlet" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="form-group">
                            <label>RG</label>
                            <input value="${cliente.rg}" name="rg" type="text" class="form-control" maxlength="15" pattern="[a-zA-Z0-9-]+" placeholder="Apenas numeros e letra">
                        </div>
                    </div><!--Fim RG-->
                    <!--CPF-->
                    <div class="col-md-3 col-sm-3">
