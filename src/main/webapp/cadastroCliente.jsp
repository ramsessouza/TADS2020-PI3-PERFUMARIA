            ...
            <form class="formulario">
                ...
                <div class="row linha-do-nome">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="form-group">
                            <label>Nome</label>
                            <input type="text" class="form-control" id="nome" maxlength="30" placeholder="Exemplo.: Zlatan Ibrahimovic" required="">
                        </div>
                    </div><!--Fim do Nome-->
                    <!--Sexo-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="form-group">
                            <label>E-mail</label>
                            <input type="email" class="form-control" placeholder="Exemplo.: cliente@cliente.com" required>
                        </div>
                    </div><!--Fim Email-->
                    <!--Telefone-->
                    <div class="col-md-3 col-sm-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                            <label>Cidade</label>
                            <input type="text" class="form-control" maxlength="40" placeholder="Exemplo.: Diadema">
                        </div>
                    </div><!--Fim Cidade-->
                    <!--Bairro-->
                    <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                            <label>Bairro</label>
                            <input type="text" class="form-control" maxlength="40" placeholder="Exemplo.: Barueri">
                        </div>
                    </div><!--Fim Bairro-->
                    <!--CEP-->
                    <div class="col-md-2 col-sm-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" maxlength="50" placeholder="Exemplo.: Av Rubens de Oliveira" required>
                        </div>
                    </div><!--Fim Endereco-->
                    <!--Numero-->
                    <div class="col-md-2 col-sm-2">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" maxlength="20" placeholder="Exemplo.: Torre 3" required>
                        </div>
                    </div><!--Fim Complemento-->
                </div><!--Fim Linha 4-->
